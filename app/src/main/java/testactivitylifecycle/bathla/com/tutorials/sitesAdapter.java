 ...
 */
public class sitesAdapter extends ArrayAdapter<StackSites> {

    ImageLoader imageLoader;
    DisplayImageOptions options;


    public sitesAdapter(Context ctx, int textViewResourceId, List<StackSites> sites) {
    ...
    */
    ...
    public View getView(int pos, View convertView, ViewGroup parent){
        ...
        if(null == row){
            ...
            row = (RelativeLayout)inflater.inflate(R.layout.row_sites,null);
        }
